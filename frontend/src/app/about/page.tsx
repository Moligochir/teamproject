...
export default function AboutPage() {
  ...
  const translations = {
    mn: {
      ...
      storyPara1:
        "PawFinder нь хувийн туршлагаас төрсөн юм. Манай үүсгэн байгуулагчийн хайртай нохой Макс хоёр долоо хоног алга болоход нийгэмлэг нэгдэж түүнийг гэртээ буцаахад тусласан юм. Энэ туршлага биднийг ижил нөхцөлд байгаа бусад амьтны эзэдэд туслах платформ үүсгэхэд урам зориг өгсөн.",
      storyPara2:
      ...
      storyPara3:
        "Нээлтээсээ хойш бид олон зуун амьтныг гэр бүлтэй нь холбоход тусласан бөгөөд бид дөнгөж эхэлж байна. Амжилтын түүх бүр биднийг сайжруулж, хүрээгээ тэлэхэд урамшуулдаг.",
      happyReunions: "Аз жаргалтай уулзалтууд!",
      happyPetsAlt: "Аз жаргалтай амьтад",

      // How It Works
      howItWorksTitle: "PawFinder хэрхэн ажилладаг вэ?",
    ...
    <div className="min-h-screen py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-sm:grid-cols-2">
            {[
              {
