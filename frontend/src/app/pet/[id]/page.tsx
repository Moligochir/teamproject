...
export default function PetDetailPage() {
  ...
  const translations = {
    mn: {
      ...
      viewSuggestions: "🤖 Санал болсон тохирол үзэх",
      myPost: "👤 Миний зар",
      ...
      myPostMessage: "Энэ бол таны зар. Засахыг үзүүлэх үү?",
    },
    en: {
      home: "Home",
      pets: "Pets",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
          <p className="text-xs font-mono text-blue-600">
            isOwner: {String(isOwner)} | userData._id: {userData?._id} |
            pet.userId._id: {pet.userId?._id}
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* OWNER SECTION - SHOW FOR OWNERS */}
            {isOwner && (
              <div className="rounded-xl p-6 border-2 border-purple-500/20 bg-purple-500/5">
                <h3 className="font-bold text-lg mb-4">{t.myPost}</h3>
                <p className="text-muted mb-6">{t.myPostMessage}</p>
                <Link
                  href="/profile"
                  className="inline-block px-6 py-2 bg-purple-500 hover:bg-purple-600 text-white rounded-lg font-semibold transition-all"
                >
                  {t.goToProfile}
                </Link>
              </div>
        ...
        {!isOwner && (
          <div className="mt-12 flex justify-center">
            <button
              ...
              className="px-8 py-4 bg-gradient-to-r from-orange-500 to-rose-500 hover:shadow-lg hover:shadow-orange-500/30 text-white rounded-full font-bold text-lg transition-all hover:-translate-y-1 active:scale-95 flex items-center gap-2"
            >
              {t.viewSuggestions}
              <span>🤖</span>
            </button>
